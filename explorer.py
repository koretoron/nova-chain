...
def mine():
    ...
    <body>
        ...
        <p>
            NOVA Network Processing Transaction
        </p>
...
def home():
    ...
    wallet_count = len(user_names)
    holders = [
    ("JINKYO SUH", jincoin.get_balance("JINKYO SUH")),
    ("ARIM KIM", jincoin.get_balance("ARIM KIM")),
    ("Charlie", jincoin.get_balance("Charlie")),
    ("NOVA_WALLET", jincoin.get_balance("NOVA_WALLET"))
    ]
    ...
    <div class="card">
        ...
        <p>🥇 {holders[0][0]} : {holders[0][1]} NOVA</p>
        <p>🥈 {holders[1][0]} : {holders[1][1]} NOVA</p>
        <p>🥉 {holders[2][0]} : {holders[2][1]} NOVA</p>
        <p>4️⃣ {holders[3][0]} : {holders[3][1]} NOVA</p>
    ...
    """
        ...
        for tx in jincoin.pending_transactions:
            html += f"""
        <p class="tx">{tx["from"]} → {tx["to"]} : {tx["amount"]} NOVA</p>
    """
